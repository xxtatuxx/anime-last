...
import { 
    ...
    Search,
    CalendarClock,
    Bell,        // ط£ظٹظ‚ظˆظ†ط© ط§ظ„ط¥ط´ط¹ط§ط±ط§طھ
    History,     // ط£ظٹظ‚ظˆظ†ط© ط§ظ„ط³ط¬ظ„
    Clock,       // ط£ظٹظ‚ظˆظ†ط© ط§ظ„ظ…ط´ط§ظ‡ط¯ط© ظ„ط§ط­ظ‚ط§
    Moon,        // ط£ظٹظ‚ظˆظ†ط© ط§ظ„ظˆط¶ط¹ ط§ظ„ظ…ط¸ظ„ظ…
    Sun,         // ط£ظٹظ‚ظˆظ†ط© ط§ظ„ظˆط¶ط¹ ط§ظ„ظ†ظ‡ط§ط±ظٹ
    Loader2,     // ط£ظٹظ‚ظˆظ†ط© ط§ظ„طھط­ظ…ظٹظ„ Spinner
    X,           // ط²ط± ط¥ط؛ظ„ط§ظ‚ ط§ظˆ ط­ط°ظپ
    MoreVertical // ط®ظٹط§ط±ط§طھ ط§ط¶ط§ظپظٹط©
...
// --- ط¥ط¯ط§ط±ط© ط§ظ„ظˆط¶ط¹ ط§ظ„ظ„ظٹظ„ظٹ ظˆط§ظ„ظ†ظ‡ط§ط±ظٹ ---
...
// طھظ‡ظٹط¦ط© ط§ظ„ط«ظٹظ… ط¹ظ†ط¯ ط§ظ„طھط­ظ…ظٹظ„
onMounted(() => {
...
// --- ط¥ط¯ط§ط±ط© ط§ظ„ط¥ط´ط¹ط§ط±ط§طھ (Notifications) ---
...
const handleOpenNotifications = async (isOpen: boolean) => {
    if (isOpen) {
        ...
        notifications.value = []; // طھطµظپظٹط± ط§ظ„ظ‚ط§ط¦ظ…ط©
        
        // ظ…ط­ط§ظƒط§ط© ط·ظ„ط¨ ظ„ظ„ط³ظٹط±ظپط± (ط§ط³طھط¨ط¯ظ„ظ‡ط§ ط¨ظ€ axios.get('/api/notifications'))
        setTimeout(() => {
            notifications.value = [
                { id: 1, title: 'طھظ… ط¥ط¶ط§ظپط© ط­ظ„ظ‚ط© ط¬ط¯ظٹط¯ط©: One Piece 1090', time: 'ظ…ظ†ط° ط¯ظ‚ظٹظ‚طھظٹظ†', image: '/storage/anime/one-piece.jpg', read: false },
                { id: 2, title: 'ط±ط¯ ط£ط­ط¯ ط§ظ„ظ…ط´ط±ظپظٹظ† ط¹ظ„ظ‰ طھط¹ظ„ظٹظ‚ظƒ', time: 'ظ…ظ†ط° ط³ط§ط¹ط©', image: null, icon: 'msg', read: true },
                { id: 3, title: 'ظپظٹظ„ظ… Demon Slayer ط§ظ„ط¬ط¯ظٹط¯ ظ…طھط§ط­ ط§ظ„ط¢ظ†', time: 'ظ…ظ†ط° 3 ط³ط§ط¹ط§طھ', image: '/storage/anime/ds-movie.jpg', read: false },
                { id: 4, title: 'طھط­ط¯ظٹط« ط£ظ…ظ†ظٹ ط¬ط¯ظٹط¯ ظ„ط­ط³ط§ط¨ظƒ', time: 'ط£ظ…ط³', image: null, icon: 'system', read: true },
            ];
            loadingNotifications.value = false;
        }, 1500); // طھط£ط®ظٹط± 1.5 ط«ط§ظ†ظٹط© ظ„ط¸ظ‡ظˆط± ط§ظ„ظ€ Spinner
    }
};

// --- ط¥ط¯ط§ط±ط© ط³ط¬ظ„ ط§ظ„ظ…ط´ط§ظ‡ط¯ط© (History) ---
...
const handleOpenHistory = async (isOpen: boolean) => {
    if (isOpen) {
        ...
        // ظ…ط­ط§ظƒط§ط© ط·ظ„ط¨ ظ„ظ„ط³ظٹط±ظپط±
        setTimeout(() => {
            watchHistory.value = [
                { id: 101, title: 'Jujutsu Kaisen Season 2', episode: 'ط§ظ„ط­ظ„ظ‚ط© 14', progress: 80, image: 'https://cdn.myanimelist.net/images/anime/1792/138022.jpg' },
                { id: 102, title: 'Spy x Family', episode: 'ط§ظ„ط­ظ„ظ‚ط© 5', progress: 30, image: 'https://cdn.myanimelist.net/images/anime/1441/122795.jpg' },
                { id: 103, title: 'Dr. Stone: New World', episode: 'ط§ظ„ط­ظ„ظ‚ط© 9', progress: 100, image: 'https://cdn.myanimelist.net/images/anime/1105/133642.jpg' },
            ];
...
// --- ط¥ط¯ط§ط±ط© ط§ظ„ظ…ط´ط§ظ‡ط¯ط© ظ„ط§ط­ظ‚ط§ظ‹ (Watch Later) ---
...
// --- ط¨ط§ظ‚ظٹ ط§ظ„ظƒظˆط¯ ط§ظ„ط£طµظ„ظٹ ---

// ط¢ط®ط± ط£ظ†ظ…ظٹ TV ظˆط¢ط®ط± Movie ظˆط¢ط®ط± ط­ظ„ظ‚ط© ظٹطھظ… ط¬ظ„ط¨ظ‡ط§ ظ…ظ† Route
const latestAnime = ref<{ latest_tv?: any; latest_movie?: any; latest_episode?: any }>({});

// ط¬ظ„ط¨ ط§ظ„ط¨ظٹط§ظ†ط§طھ ط¹ظ†ط¯ طھط­ظ…ظٹظ„ ط§ظ„طµظپط­ط©
onMounted(async () => {
  try {
...
// ط§ظ„ط±ظˆط§ط¨ط· ظ„ظ„ظ‚ط§ط¦ظ…ط© ط§ظ„ط¬ط§ظ†ط¨ظٹط© (Mobile) ظˆط§ظ„ظ‚ط§ط¦ظ…ط© ط§ظ„ظ…ظ†ط³ط¯ظ„ط©
const mainNavItems: NavItem[] = [
  { title: 'ط§ظ„ط±ط¦ظٹط³ظٹط©', href: '/ar/home', icon: Home }, // ط£ظٹظ‚ظˆظ†ط© ط§ظ„ظ…ظ†ط²ظ„
  { title: 'ط£ظ†ظ…ظٹ ط§ظ„ظ‚ط§ط¯ظ…', href: '/ar/coming-soon', icon: CalendarClock }, // ط£ظٹظ‚ظˆظ†ط© ط§ظ„ظ‚ط§ط¯ظ…
  { title: 'ظ‚ط§ط¦ظ…ط© ظ…ط³ظ„ط³ظ„ط§طھ - TV', href: '/ar/anime', icon: Tv },
  { title: 'ظ‚ط§ط¦ظ…ط© ط§ظ„ط£ظپظ„ط§ظ… - Movies', href: '/ar/movies', icon: Film },
  { title: 'ظ‚ط§ط¦ظ…ط© ط§ظ„ط­ظ„ظ‚ط§طھ - Episodes', href: '/ar/episodes-list', icon: PlayCircle },
];

// ط±ظˆط§ط¨ط· ظٹظ…ظٹظ† (طھظ… طھظ‚ظ„ظٹظ„ظ‡ط§ ظ„ط£ظ†ظ†ط§ ط£ط¶ظپظ†ط§ ط£ط²ط±ط§ط± ط¬ط¯ظٹط¯ط©)
const rightNavItems: NavItem[] = []; // طھط±ظƒطھظ‡ط§ ظپط§ط±ط؛ط© ظ„ط£ظ†ظ†ط§ ط£ط¶ظپظ†ط§ ط§ظ„ط£ظٹظ‚ظˆظ†ط§طھ ط§ظ„ط¬ط¯ظٹط¯ط© ظ…ط¨ط§ط´ط±ط© ظپظٹ ط§ظ„ظ€ Template
...
const handleClickOutside = (event: MouseEvent) => {
  if (searchWrapper.value && !searchWrapper.value.contains(event.target as Node)) {
    // Only close dropdown, don't close mobile search overlay automatically on click inside (unless we want to)
    // But if we click outside the search wrapper in mobile mode, we might want to close it.
    // For now let's keep dropdown logic separate.
    dropdownOpen.value = false;
  }
};
...
<div>
             ...
             <div class="bg-white dark:bg-[#111] border border-gray-100 dark:border-neutral-800 rounded-2xl shadow-xl overflow-hidden">
                <div class="p-2 space-y-1">
                  <div v-for="item in mainNavItems" :key="item.title">
                    <Link v-if="!['ط§ظ„ط±ط¦ظٹط³ظٹط©', 'ط£ظ†ظ…ظٹ ط§ظ„ظ‚ط§ط¯ظ…'].includes(item.title)" 
                          :href="item.href" 
        ...
        <div ref="searchWrapper" :class="['transition-all duration-300', isMobileSearchOpen ? 'fixed inset-0 z-[60] flex items-start pt-4 justify-center bg-white/95 backdrop-blur-md dark:bg-black/95 px-4' : 'relative hidden md:block w-64 lg:w-72 xl:w-80']">
          ...
          <div class="relative flex items-center w-full max-w-2xl gap-2 mx-auto mt-2 md:max-w-none md:mx-0 md:mt-0">
             <div class="relative flex-1">
                ...
                <Input v-model="searchQuery" placeholder="ط¨ط­ط«..." class="w-full h-12 pl-4 pr-12 text-base transition-all border-gray-200 rounded-full bg-gray-50 dark:bg-neutral-900 dark:border-neutral-800 focus:ring-2 focus:ring-indigo-500 md:h-10 md:text-sm md:pr-10" @focus="dropdownOpen = true"/>
             </div>
          ...
          <div v-if="dropdownOpen" class="absolute right-0 z-50 w-full mt-14 md:mt-2 overflow-hidden bg-white dark:bg-[#111] border border-gray-100 dark:border-neutral-800 rounded-2xl shadow-2xl max-h-[calc(100vh-100px)] md:max-h-[400px] overflow-y-auto">
            ...
            <div v-else>
                <div v-if="searchResults.animes.length" class="p-2">
                  <h4 class="px-3 py-2 text-xs font-bold tracking-wider text-gray-400 uppercase">ط£ظ†ظ…ظٹط§طھ</h4>
                ...
                <div v-if="searchResults.episodes.length" class="p-2 border-t border-gray-50 dark:border-neutral-800">
                  <h4 class="px-3 py-2 text-xs font-bold tracking-wider text-gray-400 uppercase">ط­ظ„ظ‚ط§طھ</h4>
                  <div v-for="ep in searchResults.episodes" :key="ep.id"
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-xs text-gray-500">ط­ظ„ظ‚ط© {{ ep.episode_number }}</span>
                    </div>
                  </div>
                </div>
        ...
        <div v-show="!isMobileSearchOpen" class="flex items-center gap-2 lg:gap-3">
            <TooltipProvider :delay-duration="0">
                <Tooltip>
                    ...
                    <TooltipContent><p>ط§ظ„ظˆط¶ط¹ {{ isDarkMode ? 'ط§ظ„ظ†ظ‡ط§ط±ظٹ' : 'ط§ظ„ظ„ظٹظ„ظٹ' }}</p></TooltipContent>
                </Tooltip>
            </TooltipProvider>
            ...
            <DropdownMenu v-if="auth?.user" @update:open="handleOpenWatchLater">
                ...
                <DropdownMenuContent  align="end" class="w-80 md:w-96 p-0 bg-white dark:bg-[#111] border-gray-100 dark:border-neutral-800 shadow-2xl rounded-2xl">
                    <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-neutral-800">
                        <h3 class="font-bold text-gray-900 dark:text-white">ط§ظ„ظ…ط´ط§ظ‡ط¯ط© ظ„ط§ط­ظ‚ط§ظ‹</h3>
                        <Link href="/watch-later" class="text-xs text-indigo-600 hover:underline dark:text-indigo-400">ط¹ط±ط¶ ط§ظ„ظƒظ„</Link>
                    </div>
                    ...
                    <div class="max-h-[350px] overflow-y-auto min-h-[150px]">
                        ...
                        <div v-else-if="watchLater.length === 0" class="flex flex-col items-center justify-center h-40 gap-2 text-gray-500">
                            ...
                            <span class="text-sm">ط§ظ„ظ‚ط§ط¦ظ…ط© ظپط§ط±ط؛ط©</span>
                        </div>
            ...
            <DropdownMenu v-if="auth?.user" @update:open="handleOpenHistory">
                ...
                <DropdownMenuContent align="end" class="w-80 md:w-96 p-0 bg-white dark:bg-[#111] border-gray-100 dark:border-neutral-800 shadow-2xl rounded-2xl">
                     <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-neutral-800">
                        <h3 class="font-bold text-gray-900 dark:text-white">ط³ط¬ظ„ ط§ظ„ظ…ط´ط§ظ‡ط¯ط©</h3>
                        <Link href="/history" class="text-xs text-indigo-600 hover:underline dark:text-indigo-400">ط¹ط±ط¶ ط§ظ„ط³ط¬ظ„ ط¨ط§ظ„ظƒط§ظ…ظ„</Link>
                    </div>
                    ...
                    <div class="max-h-[350px] overflow-y-auto min-h-[150px]">
                        ...
                        <div v-else-if="watchHistory.length === 0" class="flex flex-col items-center justify-center h-40 gap-2 text-gray-500">
                            ...
                            <span class="text-sm">ظ„ظ… طھط´ط§ظ‡ط¯ ط´ظٹط¦ط§ظ‹ ظ…ط¤ط®ط±ط§ظ‹</span>
                        </div>
                        <div v-else class="p-2 space-y-1">
            ...
            <DropdownMenu v-if="auth?.user" @update:open="handleOpenNotifications">
                ...
                <DropdownMenuContent align="end" class="w-80 md:w-[400px] p-0 bg-white dark:bg-[#111] border-gray-100 dark:border-neutral-800 shadow-2xl rounded-2xl">
                    <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-neutral-800">
                        <h3 class="font-bold text-gray-900 dark:text-white">ط§ظ„ط¥ط´ط¹ط§ط±ط§طھ</h3>
                    ...
                    <div class="max-h-[400px] overflow-y-auto min-h-[200px] custom-scrollbar">
                        ...
                        <div v-else-if="notifications.length === 0" class="flex flex-col items-center justify-center h-40 gap-2 text-gray-500">
                            ...
                            <span class="text-sm">ظ„ط§ طھظˆط¬ط¯ ط¥ط´ط¹ط§ط±ط§طھ ط¬ط¯ظٹط¯ط©</span>
                        </div>
         ...
         <div>
  <!-- ط²ط± ط§ظ„ظ…ط³طھط®ط¯ظ… ظ…ط³ط¬ظ‘ظ„ ط§ظ„ط¯ط®ظˆظ„ -->
  <DropdownMenu v-if="auth?.user">
    <DropdownMenuTrigger :as-child="true">
      <Button variant="ghost" size="icon" class="relative w-10 h-10 transition-all rounded-full ring-2 ring-transparent hover:ring-indigo-500/20">
        <Avatar class="w-9 h-9">
          <AvatarImage v-if="auth?.user?.avatar" :src="auth.user.avatar" :alt="auth?.user?.name" />
          <AvatarFallback class="text-xs font-bold text-white bg-indigo-600">
  ...
  <!-- ط²ط± ط§ظ„ظ…ط³طھط®ط¯ظ… ط؛ظٹط± ظ…ط³ط¬ظ‘ظ„ ط§ظ„ط¯ط®ظˆظ„ -->
<DropdownMenu v-if="!auth?.user">
  <DropdownMenuTrigger :as-child="true">
    <Button
      variant="ghost"
      size="icon"
      class="relative w-10 h-10 rounded-full transition-all ring-1 ring-transparent hover:ring-indigo-500/30 dark:hover:ring-indigo-400/30 bg-white dark:bg-neutral-900 shadow-sm"
    >
  ...
  >
    ...
    <DropdownMenuItem>
      <Link href="/ar/login" class="flex items-center gap-3 w-full">
        <LogIn class="w-4 h-4 text-black dark:text-white" />
        <span>طھط³ط¬ظٹظ„ ط§ظ„ط¯ط®ظˆظ„</span>
      </Link>
    </DropdownMenuItem>

    <!-- طھط³ط¬ظٹظ„ ط­ط³ط§ط¨ ط¬ط¯ظٹط¯ -->
    <DropdownMenuItem>
      <Link href="/ar/register" class="flex items-center gap-3 w-full">
        <UserPlus class="w-4 h-4 text-black dark:text-white" />
        <span>طھط³ط¬ظٹظ„ ط­ط³ط§ط¨ ط¬ط¯ظٹط¯</span>
      </Link>
    </DropdownMenuItem>

    <!-- ط§ظ„ط¹ظˆط¯ط© ظ„ظ„طµظپط­ط© ط§ظ„ط±ط¦ظٹط³ظٹط© -->
    <DropdownMenuItem>
      <Link href="/" class="flex items-center gap-3 w-full">
        <Home class="w-4 h-4 text-black dark:text-white" />
        <span>ط§ظ„ط¹ظˆط¯ط© ط¥ظ„ظ‰ ط§ظ„طµظپط­ط© ط§ظ„ط±ط¦ظٹط³ظٹط©</span>
      </Link>
    </DropdownMenuItem>
